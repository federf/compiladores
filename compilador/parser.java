...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Sep 24 17:53:43 ART 2014
  */
...
class CUP$parser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		/*System.out.println("(expression)"+e);*/ RESULT=e; 
		...
		String id = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 Simbolo s=TS.buscarSimbolo(id); //identificador
                        //System.out.println("ID encontrado? "+(s!=null));
		...
		/*System.out.println("factor "+l);*/ VarLocation res=new VarLocation("factor",l.getType(),l,0); RESULT = res; 
		...
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 //System.out.println("DIV "+s1+" , "+s2);
                                        //System.out.println("s1.getExpr(): "+s1.getExpr());
                                          //      System.out.println("s2.getExpr(): "+s2.getExpr());
                                        //verificamos que el tipo de los operandos sean validos para la operacion
                                            if(    (s1.getType().equals(Type.INT) && s2.getType().equals(Type.INT))||
		...
		int s2right = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 //System.out.println("MULT "+s1+" , "+s2);System.out.println("s1.getExpr(): "+s1.getExpr());
                                               // System.out.println("s2.getExpr(): "+s2.getExpr());
                                        //verificamos que el tipo de los operandos sean validos para la operacion
                                            if(    (s1.getType().equals(Type.INT) && s2.getType().equals(Type.INT))||
                                            (s1.getType().equals(Type.INT) && s2.getType().equals(Type.FLOAT)) ||
		...
		int s2right = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 //System.out.println("MINUS "+s1+" , "+s2);System.out.println("s1.getExpr(): "+s1.getExpr());
                                               // System.out.println("s2.getExpr(): "+s2.getExpr());
                                    //verificamos que el tipo de los operandos sean validos para la operacion
                                            if(    (s1.getType().equals(Type.INT) && s2.getType().equals(Type.INT))||
                                            (s1.getType().equals(Type.INT) && s2.getType().equals(Type.FLOAT)) ||
		...
		int s2right = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 //System.out.println("PLUS "+s1+" , "+s2);System.out.println("s1.getExpr(): "+s1.getExpr());
                                                //System.out.println("s2.getExpr(): "+s2.getExpr());
                                        //verificamos que el tipo de los operandos sean validos para la operacion
                                            if(  (s1.getType().equals(Type.INT) && s2.getType().equals(Type.INT))||
                                            (s1.getType().equals(Type.INT) && s2.getType().equals(Type.FLOAT)) ||
		...
		int s2right = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 //System.out.println("<= "+s1+" , "+s2);System.out.println("s1.getExpr(): "+s1.getExpr());
                                               // System.out.println("s2.getExpr(): "+s2.getExpr());
                                        //verificamos que el tipo de los operandos sean validos para la operacion
                                            if(    (s1.getType().equals(Type.INT) && s2.getType().equals(Type.INT))||
                                            (s1.getType().equals(Type.INT) && s2.getType().equals(Type.FLOAT)) ||
		...
		//System.out.println("!= "+r1+" , "+r2);System.out.println("r1.getExpr(): "+r1.getExpr());
                                                //System.out.println("r2.getExpr(): "+r2.getExpr());
                                                //verificamos que el tipo de los operandos sean validos para la operacion
		...
		VarLocation c2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 //System.out.println("CONJ "+c1+" , "+c2);System.out.println("c1.getExpr(): "+c1.getExpr());
                                               // System.out.println("c2.getExpr(): "+c2.getExpr());
		...
		int cright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		VarLocation c = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		////System.out.println("DISY "+e+" , "+c); System.out.println("e.getExpr(): "+e.getExpr());
                                                //System.out.println("c.getExpr(): "+c.getExpr());
                                            if(e.getType().equals(Type.BOOLEAN) && c.getType().equals(Type.BOOLEAN)){
                                                ...
                                                //System.out.println("nuevaExp: "+exp);
 ...
 TS.agregarNivel(); 
		...
		VarLocation e = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
                                            ...
                                            //System.out.println("return expression: "+e.getExpr());
                                            switch(e.getType()){
                                                case INTARRAY:
		...
		Block b = (Block)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                ...
                //si el tipo de la expression es correcto (es boolean)
                    //System.out.println("while expression: "+e.getExpr());
		...
		Block b = (Block)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                ...
                if( ( (e1.getType().equals(Type.INT) || (e1.getType().equals(Type.INTARRAY)) ) && (e2.getType().equals(Type.INT) || (e2.getType().equals(Type.INTARRAY) ) ) ) ){
                    //System.out.println("for "+e1.getExpr()+" , "+e2.getExpr()+" ;");
		...
		Block elseBlock = (Block)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 //luego de procesar el bloque else (el cual es opcional)
                if(e.getType().equals(Type.BOOLEAN)){ //si la expression es de tipo boolean
                    IfStmt res=null;
                    //System.out.println("if expression: "+e.getExpr()+" tiene if?: "+(ifBlock!=null)+" tiene else?: "+(elseBlock!=null));
...
//agregamos un nuevo nivel al arbol para el cuerpo del if
        ...
        //System.out.println("statement: location: "+l+"ao: "+ao+" expr "+e+" ;");
        //System.out.println("e.getExpr(): "+e.getExpr());
                                                            ...
                                                            //System.out.println("cond: "+((
                                                                ...
                                                                && 
                                                                    ...
                                                                    //System.out.println("no es arreglo");
                                                                    AssignStmt a=new AssignStmt((Location)l, AssignOpType.ASSIGN, (Expression) e.getExpr()); 
                                                                    RESULT=a; 
                                                                }else{
