...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Sep 27 12:21:15 ART 2014
  */
...
class CUP$parser$actions {
      ...
      switch (CUP$parser$act_num)
		...
		VarLocation f = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                ...
                                if(f.getType().equals(Type.FLOAT)){ 
                                        ...
                                        VarLocation res=new VarLocation("RESTA",Type.FLOAT,u,0);
                                        //CODIGO DE TRES DIRECCIONES
                                        TripletList.addLast(new TripletCode(UnaryOpType.MINUS, f.getExpr(), null, res));
                                        ...
                                        if(f.getType().equals(Type.INT)){                                        
                                            UnaryOpExpr u=new UnaryOpExpr(UnaryOpType.MINUS,f.getExpr());
                                            VarLocation res=new VarLocation("RESTA",Type.INT,u,0);
                                            //CODIGO DE TRES DIRECCIONES
                                            TripletList.addLast(new TripletCode(UnaryOpType.MINUS, f.getExpr(), null, res));
                                            //FIN CODIGO TRES DIRECCIONES
                                            //u.setType(Type.INT);
		...
		VarLocation f = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                    ...
                                    if(f.getType().equals(Type.BOOLEAN)){
                                        ...
                                        VarLocation res=new VarLocation("ADMIRACION",Type.BOOLEAN,u,0);
                                        //CODIGO DE TRES DIRECCIONES
                                        TripletList.addLast(new TripletCode(UnaryOpType.NON, f.getExpr(), null, res));
                                        //FIN CODIGO TRES DIRECCIONES
		...
		Expression l = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 VarLocation res=new VarLocation("factor",l.getType(),l,0); RESULT = res; 
		...
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                        ...
                                        //verificamos que el tipo de los operandos sean validos para la operacion
                                            ...
                                            (s1.getType().equals(Type.INTARRAY) && s2.getType().equals(Type.INT))
                                                ...
                                                VarLocation res=new VarLocation("PORCENTAJE",Type.INT,exp,0);                                     
                                                //CODIGO DE TRES DIRECCIONES
                                                TripletList.addLast(new TripletCode(BinOpType.MOD, s1.getExpr(), s2.getExpr(), res));                   
                                                //FIN CODIGO TRES DIRECCIONES
		...
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                        ...
                                        //verificamos que el tipo de los operandos sean validos para la operacion
                                            ...
                                            (s1.getType().equals(Type.FLOATARRAY) && s2.getType().equals(Type.FLOAT))
                                                ...
                                                VarLocation res=new VarLocation("DIVIDE",Type.INT,exp,0);                                 
                                                //CODIGO DE TRES DIRECCIONES
                                                TripletList.addLast(new TripletCode(BinOpType.DIVIDE, s1.getExpr(), s2.getExpr(), res));          
                                                //FIN CODIGO TRES DIRECCIONES
                                                //res.setType(Type.INT);
                                                RESULT=res;
                                            }else{
                                                BinOpExpr exp=new BinOpExpr(s1,BinOpType.DIVIDE,s2);
                                                VarLocation res=new VarLocation("DIVIDE",Type.FLOAT,exp,0);
                                                //CODIGO DE TRES DIRECCIONES
                                                TripletList.addLast(new TripletCode(BinOpType.DIVIDE, s1.getExpr(), s2.getExpr(), res));          
                                                //FIN CODIGO TRES DIRECCIONES
		...
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                        ...
                                        //verificamos que el tipo de los operandos sean validos para la operacion
                                            ...
                                            (s1.getType().equals(Type.FLOATARRAY) && s2.getType().equals(Type.FLOAT))
                                                ...
                                                VarLocation res=new VarLocation("MULTIPLY",Type.INT,exp,0);
                                                //CODIGO DE TRES DIRECCIONES
                                                TripletList.addLast(new TripletCode(BinOpType.MULTIPLY, s1.getExpr(), s2.getExpr(), res));
                                                //FIN CODIGO TRES DIRECCIONES
                                                //res.setType(Type.INT);
                                                RESULT=res;
                                            }else{
		...
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                    ...
                                    //verificamos que el tipo de los operandos sean validos para la operacion
                                            ...
                                            (s1.getType().equals(Type.FLOATARRAY) && s2.getType().equals(Type.FLOAT))
                                                ...
                                                VarLocation res=new VarLocation("MINUS",Type.INT,exp,0);
                                                //CODIGO DE TRES DIRECCIONES
                                                TripletList.addLast(new TripletCode(BinOpType.MINUS, s1.getExpr(), s2.getExpr(), res));
                                                //FIN CODIGO TRES DIRECCIONES
                                                //res.setType(Type.INT);
                                                RESULT=res;
                                            }else{
                                                BinOpExpr exp=new BinOpExpr(s1.getExpr(),BinOpType.MINUS,s2.getExpr());
                                                VarLocation res=new VarLocation("MINUS",Type.FLOAT,exp,0);
                                                //CODIGO DE TRES DIRECCIONES
                                                TripletList.addLast(new TripletCode(BinOpType.MINUS, s1.getExpr(), s2.getExpr(), res));
                                                //FIN CODIGO TRES DIRECCIONES
                                                //res.setType(Type.FLOAT);
                                        ...
                                        //verificamos que el tipo de los operandos sean validos para la operacion
                                            ...
                                            (s1.getType().equals(Type.FLOATARRAY) && s2.getType().equals(Type.FLOAT))
                                                ...
                                                (s1.getType().equals(Type.INTARRAY) && s2.getType().equals(Type.INT))
                                                    ...
                                                    VarLocation res=new VarLocation("PLUS",Type.INT,exp,0);
                                                    //CODIGO DE TRES DIRECCIONES
                                                    TripletList.addLast(new TripletCode(BinOpType.PLUS, s1.getExpr(), s2.getExpr(), res));
                                                    //FIN CODIGO TRES DIRECCIONES
                                                    //res.setType(Type.INT);
                                                    RESULT=res;
                                                }else{
                                                    BinOpExpr exp=new BinOpExpr(s1.getExpr(),BinOpType.PLUS,s2.getExpr());
                                                    VarLocation res=new VarLocation("PLUS",Type.FLOAT,exp,0);
                                                    //CODIGO DE TRES DIRECCIONES
                                                    TripletList.addLast(new TripletCode(BinOpType.PLUS, s1.getExpr(), s2.getExpr(), res));
                                                    //FIN CODIGO TRES DIRECCIONES
                                                    //res.setType(Type.FLOAT);
		...
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                        ...
                                        //verificamos que el tipo de los operandos sean validos para la operacion
                                            ...
                                            (s1.getType().equals(Type.FLOATARRAY) && s2.getType().equals(Type.FLOAT))
                                                ...
                                                VarLocation res=new VarLocation("MENOR_IGUAL",Type.BOOLEAN,exp,0);
                                                //CODIGO DE TRES DIRECCIONES
                                                TripletList.addLast(new TripletCode(BinOpType.LEQ, s1.getExpr(), s2.getExpr(), res));
                                                //FIN CODIGO TRES DIRECCIONES
		...
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                        ...
                                        //verificamos que el tipo de los operandos sean validos para la operacion
                                            ...
                                            (s1.getType().equals(Type.FLOATARRAY) && s2.getType().equals(Type.FLOAT))
                                                ...
                                                VarLocation res=new VarLocation("MAYOR_IGUAL",Type.BOOLEAN,exp,0);
                                                //CODIGO DE TRES DIRECCIONES   
                                                TripletList.addLast(new TripletCode(BinOpType.GEQ, s1.getExpr(),s2.getExpr(),res));
                                                //FIN CODIGO TRES DIRECCIONES
                                                //res.setType(Type.BOOLEAN);
                                                RESULT=res;
                                            }else{
		...
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                     ...
                                     //verificamos que el tipo de los operandos sean validos para la operacion
                                            ...
                                            (s1.getType().equals(Type.FLOATARRAY) && s2.getType().equals(Type.FLOAT))
                                                ...
                                                VarLocation res=new VarLocation("MAYOR",Type.BOOLEAN,exp,0);
                                                //CODIGO DE TRES DIRECCIONES
                                                TripletList.addLast(new TripletCode(BinOpType.GE, s1.getExpr(), s2.getExpr(), res));
                                                //FIN CODIGO TRES DIRECCIONES
                                                //res.setType(Type.BOOLEAN);
                                                RESULT=res;
                                            }else{
		...
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                    ...
                    //verificamos que el tipo de los operandos sean validos para la operacion
                                            ...
                                            (s1.getType().equals(Type.FLOATARRAY) && s2.getType().equals(Type.FLOAT))
                                                ...
                                                VarLocation res=new VarLocation("MENOR",Type.BOOLEAN,exp,0);
                                                //CODIGO DE TRES DIRECCIONES
                                                TripletList.addLast(new TripletCode(BinOpType.LE, s1.getExpr(), s2.getExpr(), res));
                                                //FIN CODIGO TRES DIRECCIONES
                                                //res.setType(Type.BOOLEAN);
                                                RESULT=res;
                                            }else{
		...
		VarLocation r2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                            ...
                                            if(r1.getType().equals(Type.BOOLEAN) && r2.getType().equals(Type.BOOLEAN) ||
                                                ...
                                                VarLocation res=new VarLocation("DIFERENCIA_LOGICA",Type.BOOLEAN,exp,0);
                                                //CODIGO DE TRES DIRECCIONES
                                                TripletList.addLast(new TripletCode(BinOpType.NEQ, r1.getExpr(), r2.getExpr(), res));
                                                //FIN CODIGO TRES DIRECCIONES
                                                //res.setType(Type.BOOLEAN);
                                                RESULT=res;
                                            }else{
		...
		VarLocation r2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                    ...
                                    if(r1.getType().equals(Type.BOOLEAN) && r2.getType().equals(Type.BOOLEAN) ||
                                                ...
                                                VarLocation res=new VarLocation("IGUALDAD_LOGICA",Type.BOOLEAN,exp,0);
                                                //CODIGO DE TRES DIRECCIONES
                                                TripletList.addLast(new TripletCode(BinOpType.CEQ, r1.getExpr(), r2.getExpr(), res));
                                                //FIN CODIGO TRES DIRECCIONES
                                                //res.setType(Type.BOOLEAN);
		...
		VarLocation c2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                            ...
                                            if(c1.getType().equals(Type.BOOLEAN) && c2.getType().equals(Type.BOOLEAN)){
                                                ...
                                                VarLocation res=new VarLocation("CONJUNCION",Type.BOOLEAN,exp,0);
                                                //CODIGO DE TRES DIRECCIONES
                                                TripletList.addLast(new TripletCode(BinOpType.AND, c1.getExpr(), c2.getExpr(), res));
                                                //FIN CODIGO TRES DIRECCIONES
                                                //res.setType(Type.BOOLEAN);
                                                RESULT=res;
                                            }else{
		...
		VarLocation c = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                            ...
                                            if(e.getType().equals(Type.BOOLEAN) && c.getType().equals(Type.BOOLEAN)){
                                                ...
                                                VarLocation res=new VarLocation("DISYUNCION",Type.BOOLEAN,exp,0);
                                                //CODIGO DE TRES DIRECCIONES
                                                TripletList.addLast(new TripletCode(BinOpType.OR,e.getExpr(), c.getExpr(),res));
                                                //FIN CODIGO TRES DIRECCIONES
                                                //res.setType(Type.BOOLEAN);
                                                RESULT=res;
                                            }else{
 ...
 TS.agregarNivel(); 
		...
		VarLocation e = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-4)).value;
		...
		VarLocation e = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
                                                            ...
                                                            if(e.getExpr() instanceof MethodCallExpr){ //si la expression es una llamada a un metodo
                                                                ...
                                                                if(l.getType().equals(m.getTypeReturn()) && ao.toString().equals("=") || 
                                                                    ...
                                                                    //CODIGO DE TRES DIRECCIONES
                                                                    TripletList.addLast(new TripletCode(AssignOpType.ASSIGN,e.getExpr(), null,(VarLocation)l));
                                                                    //FIN CODIGO TRES DIRECCIONES
                                                                    RESULT=a; 
                                                                }else{
                                                                        ...
                                                                        switch(l.getType()){
                                                                            ...
                                                                            case INTARRAY:
                                                                                if(m.getTypeReturn().equals(Type.INT)){
                                                                                    ...
                                                                                    //CODIGO DE TRES DIRECCIONES
                                                                                    TripletList.addLast(new TripletCode(ao,e.getExpr(), null,(VarLocation)l));
                                                                                    //FIN CODIGO TRES DIRECCIONES
                                                                                    RESULT=a; 
                                                                                }else{
		...
		String s = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 //caso identificador ID
          ...
          case 4: // NT$1 ::= 
            {
              Object RESULT =null;
 TS = new symbolTable(); TripletList=new LinkedList(); 
