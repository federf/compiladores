...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Sep 17 13:35:23 ART 2014
  */
      ...
      switch (CUP$parser$act_num)
		...
		Expression r2 = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 if(r1.getType().equals(Type.BOOLEAN) && r2.getType().equals(Type.BOOLEAN)){
                                            ...
                                            System.out.println("Error "+BinOpType.NEQ+"can only be applied to Boolean operands");
                                            //RESULT=null;
                                        }
		...
		Expression r2 = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 if(r1.getType().equals(Type.BOOLEAN) && r2.getType().equals(Type.BOOLEAN)){
                                            ...
                                            System.out.println("Error "+BinOpType.CEQ+"can only be applied to Boolean operands");
                                            //RESULT=null;
                                        }
 ...
 TS.agregarNivel(); 
		...
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 System.out.println("expr "+e);
                                                            ...
                                                            if(l.getType().equals(e.getType()) && ao.toString().equals("=") && (!l.getType().isArray())){ //si se realiza una asignacion con tipos identicos de location y expression (no array)
