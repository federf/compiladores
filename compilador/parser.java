...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Oct 06 10:56:22 ART 2014
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
                    ...
                    if(s==null){
                        ...
                        if(s.getType().isArray()){
                            if(!e.getType().equals(Type.INT)){
                                ...
                                String LabelArrayAccess="Array Access "+Labels.getLabel();
		...
		Expression b = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                ...
                String BoolLiteralLabel="BoolLiteral "+Labels.getLabel();
                TripletList.addLast(new TripletCode(TripletOperator.ASSIGN, b, null, BoolLiteralLabel));
		...
		String f = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                ...
                //CODIGO DE 3 DIRECCIONES
                String FloatLiteralLabel="FloatLiteral "+Labels.getLabel();
                TripletList.addLast(new TripletCode(TripletOperator.ASSIGN, f, null, FloatLiteralLabel));
                //FIN CODIGO 3 DIRECCIONES
		...
		String i = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                ...
                //CODIGO DE 3 DIRECCIONES
                String IntLiteralLabel="IntLiteral "+Labels.getLabel();
                TripletList.addLast(new TripletCode(TripletOperator.ASSIGN, i, null, IntLiteralLabel));
                //FIN CODIGO 3 DIRECCIONES
		...
		Type t = (Type)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
                    ...
                    TripletList.addLast(new TripletCode(TripletOperator.EXTERNINVK, res,null,null)); //!!VERIFICAR 
                    //FIN CODIGO 3 DIRECCIONES
                    RESULT=res;
		...
		LinkedList<Expression> args = (LinkedList<Expression>)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
                    ...
                    if(m!= null){
                        ...
                        for(int i=0; i<args.size(); i++){
                            TripletList.addLast(new TripletCode(TripletOperator.PARAM, null,null,args.get(i)));
                        }
                        //FIN CODIGO 3 DIRECCIONES
                        RESULT=res;
                    }else{
		...
		String s = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 //caso identificador ID
          ...
          case 4: // NT$1 ::= 
            {
              Object RESULT =null;
 TS = new symbolTable(); TripletList=new LinkedList(); ForsStack=new LinkedList(); WhilesStack=new LinkedList(); IfsStack=new LinkedList();
