...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Sep 13 19:22:51 ART 2014
  */
...
if(g.toString().equals("main")){mainDeclared=true;} switch (tipo_corriente){
                              case INT:
                                        TS.agregarMetodo(Tipo.INT, g.toString());
                                        ult_metodo=new Metodo(Tipo.INT, g.toString());
                                        break;
                              case FLOAT:
                                        TS.agregarMetodo(Tipo.FLOAT, g.toString());  
                                        break;
                              case BOOLEAN:
                                        TS.agregarMetodo(Tipo.BOOLEAN, g.toString()); 
                                        break;
                                                 }
...
if(d.toString().equals("main")){mainDeclared=true;} TS.agregarMetodo(Tipo.VOID, d.toString());
		...
		Object i = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 int size= Integer.valueOf((String) i); switch (tipo_corriente){
                                                       case INT:
                                                               TS.agregarSimbolo(Tipo.INTARRAY, s.toString(), null, size);  
                                                               break;
                                                       case FLOAT:
                                                               TS.agregarSimbolo(Tipo.FLOATARRAY, s.toString(), null, size);  
                                                               break;
                                                       case BOOLEAN:
                                                               TS.agregarSimbolo(Tipo.BOOLARRAY, s.toString(), null, size); 
                                                               break;
                                                                           }
