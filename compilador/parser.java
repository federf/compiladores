...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Oct 20 15:53:16 ART 2014
  */
                    ...
                    if(s==null){
                        ...
                        if(s.getType().isArray()){
                            if(!e.getType().equals(Type.INT)){
                                ...
                                VarLocation arrAccess=new VarLocation(id.toString(),s.getType(), e,0);
                        ...
                        if(s.getType().isArray()){
                            ...
                            if(e.getExpr() instanceof BinOpExpr){
                                if(!e.getType().equals(Type.INT)){
                                    ...
                                    VarLocation v=new VarLocation((String)id,s.getType(),e,s.getSize());
                                ...
                                if(!e.getType().equals(Type.INT)){
                                    ...
                                    if(e2.getValue()<0){
                                        ...
                                        VarLocation v=new VarLocation((String)id,s.getType(),e2,s.getSize());
                                        //System.out.println("OFFSET = " + v.getOffset());
                                        v.setType(s.getType());
                                        RESULT=v ;
                                    }
                                                    ...
                                                    switch (tipo_corriente){
                                                           case INT:
                                                                    ...
                                                                    if(TS.getCorriente().esRaiz()){
                                                                        TripletList.addLast(new TripletCode(TripletOperator.GLOBAL, tipo_corriente,s.toString(),i));
                                                                    }
                                                                    //FIN CODIGO TRES DIRECCIONES
                                                                    break;
                                                           case FLOAT:
