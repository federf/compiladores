...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Nov 12 00:22:21 ART 2014
  */
...
class CUP$parser$actions {
    ...
    boolean inLoop;
    //variable booleana que indicaria que estamos dentro del cuerpo de un metodo
    boolean inMethod;
      ...
      switch (CUP$parser$act_num)
                    ...
                    if(s==null){
                        ...
                        if(s.getType().isArray()){
                            if(!e.getType().equals(Type.INT)){
                                ...
                                RESULT= new ArrayLiteral((String)id, e, s.getType());
                            }
                        }else{
		...
		String id = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		   Simbolo s=TS.buscarSimbolo(id); //identificador
                        ...
                        //si estamos dentro de un metodo
                        if(inMethod){
                            //si el simbolo leido es un parametro del metodo leido

                            int paramIndex=ult_metodo.esParametro(s);
                            if(paramIndex>=0){
                                //calculamos su offset
                                //cantidad de parametros del metodo
                                int cantParams=ult_metodo.getParametros().size();
                                System.out.println("simbolo: "+s.getName());
                                if(paramIndex==0){
                                    System.out.println("IF");
                                    ultOffsetLeido=8;
                                }else{
                                    System.out.println("ELSE");
                                    ultOffsetLeido=(((cantParams)-paramIndex)+2)*4;    
                                }
                                System.out.println("ultOffsetLeido: "+ultOffsetLeido);
                                
                            }else{
                                //sino, utilizamos el de su declaracion, ya que se trata de una variable declarada
                                //la cual no es un parametro del metodo
		...
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                        ...
                                        //verificamos que el tipo de los operandos sean validos para la operacion
                                            ...
                                            (s1.getType().equals(Type.INTARRAY) && s2.getType().equals(Type.INT))
                                                ...
                                                BinOpExpr exp=new BinOpExpr(s1,BinOpType.MOD,s2);  
                                        ...
                                        //verificamos que el tipo de los operandos sean validos para la operacion
                                            if(validOperators(s1,s2)){
                                                ...
                                                (s1.getType().equals(Type.INTARRAY) && s2.getType().equals(Type.INT))
                                                    ...
                                                    BinOpExpr exp=new BinOpExpr(s1,BinOpType.MULTIPLY,s2);
                                                    exp.setType(Type.INT);
		...
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                    ...
                                    //verificamos que el tipo de los operandos sean validos para la operacion
                                            if(validOperators(s1,s2)){
                                                ...
                                                BinOpExpr exp=new BinOpExpr(s1,BinOpType.MINUS,s2);
                                                exp.setType(Type.INT);
                                        ...
                                        //verificamos que el tipo de los operandos sean validos para la operacion
                                            if(validOperators(s1,s2)){
                                                ...
                                                (s1.getType().equals(Type.INTARRAY) && s2.getType().equals(Type.INT))
                                                    ...
                                                    BinOpExpr exp=new BinOpExpr(s1,BinOpType.PLUS,s2);
                                                    exp.setType(Type.INT);
		...
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                        ...
                                        //verificamos que el tipo de los operandos sean validos para la operacion
                                            if(validOperators(s1,s2)){
                                                ...
                                                BinOpExpr exp=new BinOpExpr(s1,BinOpType.LEQ,s2);
		...
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                        ...
                                        //verificamos que el tipo de los operandos sean validos para la operacion
                                            if(validOperators(s1,s2)){
                                                ...
                                                BinOpExpr exp=new BinOpExpr(s1,BinOpType.GEQ,s2);
                                                exp.setType(Type.BOOLEAN);
		...
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                     ...
                                     //verificamos que el tipo de los operandos sean validos para la operacion
                                            if(validOperators(s1,s2)){
                                                ...
                                                BinOpExpr exp=new BinOpExpr(s1,BinOpType.GE,s2);
                                                exp.setType(Type.BOOLEAN);
		...
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                    ...
                    //verificamos que el tipo de los operandos sean validos para la operacion
                                            if(validOperators(s1,s2)){
                                                ...
                                                BinOpExpr exp=new BinOpExpr(s1,BinOpType.LE,s2);
                                                exp.setType(Type.BOOLEAN);
		...
		VarLocation r2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                            ...
                                            if( logicValidOperators(r1,r2)){
                                                ...
                                                BinOpExpr exp= new BinOpExpr(r1,BinOpType.NEQ,r2);
                                                exp.setType(Type.BOOLEAN);
		...
		VarLocation r2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                            ...
                                            if(logicValidOperators(r1,r2)){
                                                ...
                                                BinOpExpr exp= new BinOpExpr(r1,BinOpType.CEQ,r2);
                                                exp.setType(Type.BOOLEAN);
		...
		VarLocation c2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                            ...
                                            if(c1.getType().equals(Type.BOOLEAN) && c2.getType().equals(Type.BOOLEAN)){
                                                ...
                                                BinOpExpr exp=new BinOpExpr(c1,BinOpType.AND,c2);
                                                exp.setType(Type.BOOLEAN);
		...
		VarLocation c = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                            ...
                                            if(e.getType().equals(Type.BOOLEAN) && c.getType().equals(Type.BOOLEAN)){
                                                ...
                                                BinOpExpr exp=new BinOpExpr(e,BinOpType.OR,c);
                                                exp.setType(Type.BOOLEAN);
		...
		Type t = (Type)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
                    ...
                    TripletList.addLast(new TripletCode(TripletOperator.PARAM, null,null,null));
...
//agregamos un nuevo nivel al arbol para el cuerpo del if
                                                                        ...
                                                                        switch(l.getType()){
                                                                            ...
                                                                            case INTARRAY:
                                                                                if(m.getTypeReturn().equals(Type.INT)){
                                                                                    ...
                                                                                    //CODIGO DE TRES DIRECCIONES
                                                                                    switch(ao){
                                                                                        case ASSIGN:TripletList.addLast(new TripletCode(TripletOperator.ASSIGN,e, null,(VarLocation)l));
                                                                                            break;
                                                                                        case INCREMENT:TripletList.addLast(new TripletCode(TripletOperator.INCREMENT,e, null,(VarLocation)l));
                                                                                            break;
                                                                                        case DECREMENT:TripletList.addLast(new TripletCode(TripletOperator.DECREMENT,e, null,(VarLocation)l));
                                                                                            break;
                                                                                    }
                                                                                    //FIN CODIGO TRES DIRECCIONES
                                                                                    RESULT=a; 
		...
		String g = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-4)).value;
                            ...
                            TS.SubirNivel();
                            //seteamos la variable inMethod en falso al salir del cuepor del metodo
                            inMethod=false;
		...
		String g = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
                            ...
                            //declaramos que entraremos al cuerpo de un metodo
                            inMethod=true;
 ...
 //luego de leer los parametros
                        ...
                        if(!ult_metodo.getName().equals("main")){
                            ...
                            for(int i=0; i<e.getParametros().size(); i++){
                                Simbolo actual = e.getParametros().get(i);
                                TS.agregarSimbolo(actual.getType(), actual.getName(), actual.getValue(), actual.getSize(),((e.getParametros().size()-i)+2)*4);
                            }

                            for(int i=e.getParametros().size()-1; i>=0; i--){
                                Simbolo actual = e.getParametros().get(i);
                                if(i!=0){
                                    //creamos el parametro como VarLocation para darle un offset
                                    VarLocation p=new VarLocation(actual.getName(), actual.getType(),null,actual.getSize(),(((i+2))*4));
                                    p.addVarLocation(p);
                                }else{
                                    VarLocation p=new VarLocation(actual.getName(), actual.getType(),null,actual.getSize(),8);
                                    p.addVarLocation(p);
                                }
                            }
                        }else{//sino, si el metodo leido fue main
