...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Sep 29 12:51:00 ART 2014
  */
...
class CUP$parser$actions {
 ...
 TS.agregarNivel(); 
		...
		Block elseBlock = (Block)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                ...
                if(e.getType().equals(Type.BOOLEAN)){ //si la expression es de tipo boolean
                    ...
                    System.out.println("label  - - - - "+LabelsStack.getLast());
                    ...
                    LabelsStack.removeLast();
                    System.out.println("stack al final: "+LabelsStack);
 ...
 /*subimos de nivel luego del bloque if*/TS.SubirNivel(); 
                    ...
                    System.out.println("label else - - - - "+LabelsStack.get(LabelsStack.size()-2));
		...
		VarLocation e = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                    ...
                    System.out.println("stack"+LabelsStack);
