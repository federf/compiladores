...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri Oct 17 16:37:22 ART 2014
  */
		...
		VarLocation s2 = (VarLocation)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                    ...
                                    //verificamos que el tipo de los operandos sean validos para la operacion
                                            if(validOperators(s1,s2)){
                                                ...
                                                System.out.println("OFFSET = " + res.getOffset());
                                                //CODIGO DE TRES DIRECCIONES
                                                System.out.println("minus 1- "+s1.getExpr()+"("+s1.getType()+")"+" , "+s2.getExpr()+"("+s2.getType()+")");
                                                ...
                                                RESULT=res;
                                                    ...
                                                    System.out.println("OFFSET = " + res.getOffset());
                                                    System.out.println("minus 2- "+s1.getExpr()+"("+s1.getType()+")"+" , "+s2.getExpr()+"("+s2.getType()+")");
                                                    //CODIGO DE TRES DIRECCIONES 
                                                    TripletList.addLast(new TripletCode(TripletOperator.MINUS, s1.getExpr(), s2.getExpr(), res));
                                                    //FIN CODIGO TRES DIRECCIONES
                                                    RESULT=res;
