...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Sep 18 17:13:24 ART 2014
  */
...
class CUP$parser$actions {
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		Type t = (Type)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
                    ...
                    //System.out.println("string: "+s+", type_or_void: "+t);
		...
		LinkedList<Expression> args = (LinkedList<Expression>)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
                        ...
                        //System.out.println("string: "+s+", type_or_void: "+t+", args: "+args);
		...
		LinkedList<Expression> args = (LinkedList<Expression>)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
                    ...
                    //System.out.println("METHODCALL con params  "+id+", "+args);
                    ...
                    //System.out.println("[CONPARAMETROS]m no nulo? : "+(m!=null));
                    if(m!= null){
		...
		String id = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
                    ...
                    //System.out.println("METHODCALL sin params "+id);
                    Metodo m=TS.buscarMetodo(id, new LinkedList());
                    //System.out.println("[SINPARAMETROS]m no nulo? : "+(m!=null));
                    if(m!= null){
          ...
          case 47: // statement ::= RETURN PUNTO_Y_COMA 
            {
              Object RESULT =null;
                                    ...
                                    if(!ult_metodo.getTypeReturn().equals(Type.VOID)){
                                         ...
                                         System.out.println("ReturnStmt con void");
 ...
 TS.agregarNivel(); 
		...
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
                                                            ...
                                                            System.out.println("location{"+l.getId()+", "+l.getType()+"}"+"operacion "+ao+" expresion: "+e);
                                                            if(e instanceof MethodCallExpr){ //si la expression es una llamada a un metodo
                                                                ...
                                                                Metodo m= TS.buscarMetodo(actual.getName(), tipoArgumentos);
                                                                System.out.println("encontrado?: "+(m!=null));

                                                                System.out.println("[1era cond] : "+(l.getType().equals(m.getTypeReturn()) && ao.toString().equals("=") || 
                                                                ...
                                                                if(l.getType().equals(m.getTypeReturn()) && ao.toString().equals("=") || 
                                                                    ...
                                                                    //System.out.println("location: "+l+", assign_op: "+ao+", expresion: "+e);
                                                                ...
                                                                if(l.getType().equals(e.getType()) && ao.toString().equals("=") || 
                                                                    ((l.getType().equals(Type.FLOAT) || l.getType().equals(Type.FLOATARRAY)) && 
                                                                        (e.getType().equals(Type.INT) || e.getType().equals(Type.INTARRAY) )) && 
                                                                        (!l.getType().isArray())){ //si se realiza una asignacion con tipos identicos de location y expression (no array)
                                                                    //System.out.println("assing ok (=)");
                                                                    AssignStmt a=new AssignStmt((Location)l, AssignOpType.ASSIGN, (Expression) e); 
                                                                    //System.out.println("location: "+l+", assign_op: "+ao+", expresion: "+e);
