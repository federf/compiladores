...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri Nov 14 10:58:15 ART 2014
  */
                        ...
                        if(!ult_metodo.getName().equals("main")){
                            ...
                            for(int i=e.getParametros().size()-1; i>=0; i--){
                                ...
                                if(i!=0){
                                    ...
                                    VarLocation p=new VarLocation(actual.getName(), actual.getType(),null,actual.getSize(),(i*4));
                                    p.addVarLocation(p);
                                }else{
                                    VarLocation p=new VarLocation(actual.getName(), actual.getType(),null,actual.getSize(),0);
                                    p.addVarLocation(p);
                                }
                            }
                        }else{//sino, si el metodo leido fue main
