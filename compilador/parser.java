...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri Sep 19 13:24:10 ART 2014
  */
...
class CUP$parser$actions {
    ...
    boolean inLoop;
    //variable de tipo nodo que guarda el nivel donde comienza un ciclo para en caso de encontrar un break poder volver a su padre
    Node ActualLoopLevel; 
 ...
 TS.agregarNivel(); 
		...
		SemiColon pyc = (SemiColon)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT=pyc; 
		...
		if(!inLoop){ 
                                        ...
                                        RESULT=res;
                                        TS.setCorriente(ActualLoopLevel.getPadre());
                                        //TS.SubirNivel();
                                    } 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("statement",4, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
		...
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                ...
                TS.agregarNivel();
                ActualLoopLevel=TS.getCorriente(); 
                inLoop=true;
 ...
 TS.agregarNivel(); 
		...
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
                                                            ...
                                                            if(e instanceof MethodCallExpr){ //si la expression es una llamada a un metodo
                                                                ...
                                                                System.out.println("location: "+l+", assign_op: "+ao+", expresion: "+e);
                                                                System.out.println("{expression TYPE} "+e.getType());
                                                                if(
                                                                    (
