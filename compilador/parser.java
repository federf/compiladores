...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Nov 03 11:30:22 ART 2014
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		Expression l = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
            ...
            //si lo que sube es un literal (int, float, bool, array o string)
            ...
            if(ultOffsetLeido!=0){
                VarLocation res=new VarLocation(ultVarLeida,l.getType(),l,0,ultOffsetLeido); RESULT = res;
                ultOffsetLeido=0;
                ultVarLeida="";
            }else{
